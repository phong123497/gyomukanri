...
// SystemName: 業務管理
// ClassName: Pcsk020VarDempyoApItem
//
...
@Getter
@Setter
public class Pcsk020VarDempyoCoreItem implements Serializable {
	...
	/** 借方摘要１ */
	private String krtekiy1;

	/** 借方摘要２ */
	private String krtekiy2;
	...
	/** 貸方適用１ */
	private String kstekiy1;

	/** 貸方適用２ */
	private String kstekiy2;
